...
//op��o para evitar CRSF, dessa forma n�o precisa decorar nas actions nos controllers
builder.Services.AddControllersWithViews(options =>
{
    options.Filters.Add(new AutoValidateAntiforgeryTokenAttribute());
});

// Adicionando suporte a mudan�a de conven��o da rota das areas. MUDAN�A NOME PASTA [AREA] => [M�DULOS]
